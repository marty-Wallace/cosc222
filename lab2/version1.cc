/*  
    ...
    Approach: Read ids into a vector then double loop over them comparing each 
	number and keeping tack of the highest number of digits required for 
	uniqueness
...
/*
	return the minimum numbers of digits for uniqueness between two numbers
*/
...
/*
	Loop over vector of student numbers in O(n*n) time and keep track of 
	largest number of digits required for uniqueness
*/
